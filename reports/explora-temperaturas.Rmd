...
```{r}
ggplot(data=chuvas_cg, mapping = aes(x = paste(day(semana), month(semana), year(semana), sep="/"), y = chuva)) + xlab("Data") + ylab("Chuva em mm³") + ggtitle("Campina Grande") + theme(plot.title = element_text(hjust = 0.5)) + geom_point()
```
